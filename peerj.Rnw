...
\title{Quality of software teams: A global online survey of industrial best practices}
...
desc.names <- c("Age", "Paid programming hrs", "Programming education hrs", "Unpaid (e.g., open source) hrs", "Fraction actual paid programming percent", "General programming skill 1-5", "Actual paid programming hrs week", "Programming experience yrs")
...
kable(tab1, format="latex", digits=c(0,2,2,2,2), caption="Table 1")
# % install.packages("stargazer")
# % library(stargazer)
# % stargazer(tab1, title="Stargazer", type="html")
@
...
xtable(tab1[-1,], digits=c(0,0,1,1,0,2), caption="Table 1 using xtable")
@
